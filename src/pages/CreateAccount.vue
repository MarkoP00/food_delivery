...
//check inputs
  ...
  Object.keys(formData).forEach((key) => {
    if (formData[key].value === '') {
      ...
      icon.value = '❌';
      border.value = true;
      popupMessage.value = 'Please, fill all input fields... Also, passwords must match!';
    ...
    if (key === 'email' && !formData.email.value.includes('@')) {
      ...
      icon.value = '❌';
      border.value = true;
      popupMessage.value = 'Your email must include @ symbol!';
        ...
        Object.values(formData).some(async (value) => {
            if (!value.invalid) {
                ...
                if (createUser.status === 'ok') {
                    ...
                    popupMessage.value = 'You can now login to this user!';
